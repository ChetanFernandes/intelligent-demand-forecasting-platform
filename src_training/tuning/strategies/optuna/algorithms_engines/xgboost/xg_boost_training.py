...
class XGBoostTrainingEngine:
    ...
    def evaluate(self, params,  progress_reporter = None):
        ...
        for fold, (train_index, validation_index) in enumerate(time_series_split.split(self.X_train), start=1):
            ...
            model = self.estimator.__class__(random_state = 42, eval_metric="rmse", early_stopping_rounds=50, enable_categorical=False, **params) 
            ...
            # Here if you notice I am using model level (XGboost) early stopping. I have not used it for Gird and Random becuase it not straight forward
